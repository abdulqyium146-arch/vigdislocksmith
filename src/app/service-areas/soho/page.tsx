...
export const metadata: Metadata = {
  ...
  description: "Emergency locksmith in Soho W1. Fast response, no call-out fee. Covering Old Compton Street, Dean Street, Wardour Street. Call +44 7984 547185.",
...
export default function SohoPage() {
  ...
  return (
    <>
      ...
      <SchemaScript schema={getAreaSchema("Soho", ["W1D", "W1F", "W1B"], 51.5137, -0.1337, `${BUSINESS.url}/service-areas/soho`)} />
