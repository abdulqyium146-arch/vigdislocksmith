...
export const metadata: Metadata = {
  ...
  description: "Professional locksmith in Belgravia SW1X. Emergency lockouts, lock repair, lock replacement. 15-30 min response. Call +44 7984 547185.",
...
export default function BelgraviaPage() {
  ...
  return (
    <>
      ...
      <SchemaScript schema={getAreaSchema("Belgravia", ["SW1X", "SW1W"], 51.4961, -0.1538, `${BUSINESS.url}/service-areas/belgravia`)} />
      ...
      <NearbyAreaLinks currentArea="belgravia" />
