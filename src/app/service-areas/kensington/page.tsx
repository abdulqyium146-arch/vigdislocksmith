...
export const metadata: Metadata = {
  ...
  description: "Expert locksmith in Kensington W8 & SW7. Kensington High Street, Kensington Palace Gardens covered. 24/7 service. Call +44 7984 547185.",
...
export default function KensingtonPage() {
  ...
  return (
    <>
      ...
      <SchemaScript schema={getAreaSchema("Kensington", ["W8", "W14"], 51.5018, -0.1919, `${BUSINESS.url}/service-areas/kensington`)} />
      ...
      <NearbyAreaLinks currentArea="kensington" />
