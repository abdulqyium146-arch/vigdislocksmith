...
export const metadata: Metadata = {
  ...
  description:
    "Vigdis Locksmith London covers Mayfair, Westminster, Belgravia, Knightsbridge, Soho, Marylebone, Chelsea, Kensington and all of Central London. Call +44 7984 547185.",
