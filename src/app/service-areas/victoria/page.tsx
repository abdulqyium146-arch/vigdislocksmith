...
export const metadata: Metadata = {
  ...
  description: "Professional locksmith in Victoria SW1V. Near Victoria Station. Emergency service 24/7. Fast response. Call +44 7984 547185.",
...
export default function VictoriaPage() {
  ...
  return (
    <>
      ...
      <SchemaScript schema={getAreaSchema("Victoria", ["SW1E", "SW1W", "SW1V"], 51.4965, -0.1439, `${BUSINESS.url}/service-areas/victoria`)} />
      ...
      <NearbyAreaLinks currentArea="victoria" />
