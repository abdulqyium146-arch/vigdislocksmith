...
export const metadata: Metadata = {
  ...
  description: "Expert locksmith in Paddington W2. Emergency lockouts near Paddington Station. 24/7 service, fast response. Call +44 7984 547185.",
...
export default function PaddingtonPage() {
  ...
  return (
    <>
      ...
      <SchemaScript schema={getAreaSchema("Paddington", ["W2", "W9"], 51.5154, -0.1755, `${BUSINESS.url}/service-areas/paddington`)} />
      ...
      <NearbyAreaLinks currentArea="paddington" />
