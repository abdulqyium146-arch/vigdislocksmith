...
export const metadata: Metadata = {
  ...
  description: "Expert locksmith in Chelsea SW3. King's Road, Sloane Square, Chelsea Embankment covered. 24/7 emergency service. Call +44 7984 547185.",
...
export default function ChelseaPage() {
  ...
  return (
    <>
      ...
      <SchemaScript schema={getAreaSchema("Chelsea", ["SW3", "SW10"], 51.4854, -0.1693, `${BUSINESS.url}/service-areas/chelsea`)} />
      ...
      <NearbyAreaLinks currentArea="chelsea" />
