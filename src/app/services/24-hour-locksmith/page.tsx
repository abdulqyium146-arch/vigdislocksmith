...
export const metadata: Metadata = {
  ...
  description:
    "24-hour locksmith in Mayfair and Central London. We never close — midnight, Christmas Day, or any time you need us. Call +44 7984 547185.",
...
export default function TwentyFourHourPage() {
  ...
  return (
    <>
      ...
      <SchemaScript schema={getWebPageSchema(`${BUSINESS.url}/services/24-hour-locksmith`, "24 Hour Locksmith Mayfair — Available Every Hour", "Round-the-clock locksmith in Mayfair, 365 days a year. No extra charge for nights or weekends. Call +44 7984 547185.")} />
