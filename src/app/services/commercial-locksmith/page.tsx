...
export const metadata: Metadata = {
  ...
  description:
    "Specialist commercial locksmith services in Mayfair. Office lockouts, access control, master key systems. Call +44 7984 547185.",
...
export default function CommercialLocksmithPage() {
  ...
  return (
    <>
      ...
      <SchemaScript schema={getSpeakableSchema(`${BUSINESS.url}/services/commercial-locksmith`)} />
      <SchemaScript schema={getWebPageSchema(`${BUSINESS.url}/services/commercial-locksmith`, "Commercial Locksmith Mayfair — Business Security Specialists", "Specialist commercial locksmith services in Mayfair. Office lockouts, access control, master key systems. Call +44 7984 547185.")} />
      ...
      <LinkedAreaChips serviceName="Commercial Locksmith" />
      <RelatedServices currentSlug="commercial-locksmith" />
