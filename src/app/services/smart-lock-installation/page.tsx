...
export const metadata: Metadata = {
  ...
  description:
    "Professional smart lock installation in Mayfair. Keyless entry, app-controlled, biometric. Leading brands fitted by certified locksmiths. Call +44 7984 547185.",
...
export default function SmartLockPage() {
  ...
  return (
    <>
      ...
      <SchemaScript schema={getSpeakableSchema(`${BUSINESS.url}/services/smart-lock-installation`)} />
      <SchemaScript schema={getWebPageSchema(`${BUSINESS.url}/services/smart-lock-installation`, "Smart Lock Installation Mayfair — App-Controlled Access", "Professional smart lock installation in Mayfair. Keyless entry, app-controlled, biometric. Leading brands fitted by certified locksmiths. Call +44 7984 547185.")} />
      ...
      <LinkedAreaChips serviceName="Smart Lock Installation" />
      <RelatedServices currentSlug="smart-lock-installation" />
