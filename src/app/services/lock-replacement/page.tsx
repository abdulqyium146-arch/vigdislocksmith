...
export const metadata: Metadata = {
  ...
  description:
    "Professional lock replacement in Mayfair. BS3621 approved locks, high-security cylinders. Supplied and fitted by certified locksmiths. Call +44 7984 547185.",
...
export default function LockReplacementPage() {
  ...
  return (
    <>
      ...
      <SchemaScript schema={getWebPageSchema(`${BUSINESS.url}/services/lock-replacement`, "Lock Replacement Mayfair — BS3621 & High-Security Locks", "Professional lock replacement in Mayfair. BS3621 approved and high-security locks supplied and fitted. Call +44 7984 547185.")} />
      ...
      <LinkedAreaChips serviceName="Lock Replacement" />
      <RelatedServices currentSlug="lock-replacement" />
