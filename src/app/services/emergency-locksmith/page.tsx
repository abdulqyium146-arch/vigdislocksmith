...
export const metadata: Metadata = {
  ...
  description:
    "Locked out in Mayfair? Our emergency locksmiths arrive in 15-30 minutes, 24/7. No call-out fee. DBS checked technicians. Call +44 7984 547185 now.",
...
const steps = [
  {
    step: "1",
    title: "Call Us",
    desc: "Call +44 7984 547185. Our team will take your details and confirm a fixed price quote on the phone.",
  },
  {
    step: "2",
    title: "We Dispatch",
  ...
  return (
    <>
      ...
      <SchemaScript schema={getHowToSchema(
        ...
        [
          { name: "Call Vigdis Locksmith London", text: "Call +44 7984 547185 immediately. Our team answers 24/7. Tell us your location and the nature of the problem. We will give you a fixed price quote on the phone." },
