...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive residential locksmith services in Mayfair. Lock changes, upgrades, burglary repair, security surveys. Call +44 7984 547185.",
...
export default function ResidentialLocksmithPage() {
  ...
  return (
    <>
      ...
      <SchemaScript schema={getWebPageSchema(`${BUSINESS.url}/services/residential-locksmith`, "Residential Locksmith Mayfair — Home Security Experts", "Comprehensive residential locksmith services in Mayfair. Lock changes, upgrades, burglary repair, security surveys. Call +44 7984 547185.")} />
      ...
      <LinkedAreaChips serviceName="Residential Locksmith" />
      <RelatedServices currentSlug="residential-locksmith" />
