...
export const metadata: Metadata = {
  ...
  description:
    "Professional key cutting in Mayfair and Central London. Yale, Mortice, Chubb, security keys and more. Fast, accurate cutting. Call +44 7984 547185.",
...
export default function KeyCuttingPage() {
  ...
  return (
    <>
      ...
      <SchemaScript schema={getSpeakableSchema(`${BUSINESS.url}/services/key-cutting`)} />
      <SchemaScript schema={getWebPageSchema(`${BUSINESS.url}/services/key-cutting`, "Key Cutting Mayfair — All Key Types Cut Precisely", "Professional key cutting in Mayfair and Central London. Yale, Mortice, Chubb, security keys and more. Fast, accurate cutting. Call +44 7984 547185.")} />
      ...
      <LinkedAreaChips serviceName="Key Cutting" />
      <RelatedServices currentSlug="key-cutting" />
